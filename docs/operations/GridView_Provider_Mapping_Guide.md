...
> observed circuit identifiers still have no curated circuit mapping - six were
> curated by 2026-09-19 (Provider Evaluation §8.8.1), and of the rest
> `hungaroring` is acknowledged unmapped while 16 need a new canonical GridView
> circuit identity - so a working calendar stays blocked. The only provider requests on record are
