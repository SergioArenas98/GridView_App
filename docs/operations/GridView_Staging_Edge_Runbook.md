...
`SEASON_PUBLICATION_CUTOVER_CONTROL` (`seed:2026`) and
`SEASON_PUBLICATION_AUTHORITY` (`sequencer`, prepared 2026-09-15) vars. A dry-run of the temporary season-2026
