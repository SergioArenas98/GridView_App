 ...
 * reviewed commit.
 *
 * A complete driver dataset is not a port. When it merged nothing consumed it
 * and no drivers, constructors or participants port existed; the dormant,
 * fixture-tested participants port added later (Implementation Plan §14.0.21)
 * now resolves these mappings, and is registered nowhere.
 *
